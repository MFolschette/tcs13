...
Let $S$ be a set of atoms: a definite rule is satisfied by $S$ if $\atom{H} \in S$,
...
before solving, any rule containing variables is grounded, that is replaced by an equivalent set of rules with constants only.
