...
(\pref{eq:edges-inference-pos} \& \eqref{eq:edges-inference-neg}).
...
We point out that one of the benefits of this alternative inference is the fact that the conditions used to infer each influence
in \pref{eq:edges-inference-pos} \& \eqref{eq:edges-inference-neg}
