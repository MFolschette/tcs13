...
\todo{Find a new semantics that could tackle unsigned edges}
\newcommand{\uns}{\pm}
...
and $E \subset \{ \GRNedge{a}{s}{t}{b} %\in \Gamma \times S \times \sN \times \Gamma 
...
\begin{definition}[\new{Effective levels ($\levelsl$)}]\label{def:levels}
...
\begin{definition}[\new{Asynchronous dynamics}]\label{def:dynamics}
