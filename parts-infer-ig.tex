...
\todo{The two following subsections (down to “Interaction Inference”) have a lot of definitions but few examples and not enough informal explanations, especially on their use.
Especially:
\begin{itemize}
  \item What kinds of concept do represent $\focals$?
  \item What is the importance of a strict context?
  \item Add an outline guiding the reader through these subsections.
\end{itemize}}
