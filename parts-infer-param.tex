...
\todo{update text: IG can be given by the user + details}
...
that the associated IG $(\Gamma, E)$ verifies the following property:
\modLP{
\begin{align}
\begin{split}
...
Hence \modLP{$K_{a,\omega} = \focals(a,S_a(\sigma_{a,\omega}),\sigma_{a,\omega})$ if this latter is
